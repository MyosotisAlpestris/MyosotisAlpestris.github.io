...
\tikzset{
	...
	arn_n/.style = {treenode, circle, PageColor, draw=., fill=., text width=2.5em, font=\sffamily\bfseries},
...
\tikzset{
	treenode/.style = {align=center, inner sep=3pt, font=\sffamily},
	arn_n/.style = {treenode, circle, white, draw=black, fill=black, text width=2.5em, font=\sffamily\bfseries},
